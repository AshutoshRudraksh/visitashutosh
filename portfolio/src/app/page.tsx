        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
              Experience in building <span className="text-white font-semibold">large-scale infrastructures</span>, <span className="text-white font-semibold">backend microservice architectures</span>, and <span className="text-white font-semibold">AI systems</span>. Delivered customer-facing product solutions that drive <span className="text-white font-semibold">real business impact</span>. 
